...
class F5TTSProvider(BaseProvider):
    ...
    async def _get_model(self) -> Any:
        ...
        try:
            ...
            raise ProviderError(f"Failed to initialize F5-TTS model: {e!s}") from e
    ...
    async def generate(self, text: str, voice_id: str, output_path: str) -> None:
        ...
        try:
            ...
            raise ProviderError(f"F5-TTS generation failed: {e!s}") from e
    ...
    async def list_voices(self) -> list[Voice]:
        ...
        try:
            ...
            raise ProviderError(f"Failed to list F5-TTS voices: {e!s}") from e
    ...
    try:
        ...
        try:
            await provider.generate(
                "Hello, this is a test of F5 TTS provider.", "default", temp_path
            )
