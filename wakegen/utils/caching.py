...
class GenerationCache:
    ...
    def get(self, text: str, voice_id: str, provider: str) -> str | None:
        """
    ...
    def get_cache_path(
        self, text: str, voice_id: str, provider: str, extension: str = ".wav"
    ) -> str:
        """
...
class CacheManager:
    ...
    def get(
        self, text: str, voice_id: str, params: dict[str, Any] | None = None
    ) -> str | None:
        """
