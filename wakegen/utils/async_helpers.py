...
class ParallelExecutor:
    ...
    def __init__(self, max_concurrent: int = 4, rate_limit: float | None = None):
        """
        ...
        async def run_task(task_id: int, task: T) -> TaskResult[Any]:
            ...
            async with self._semaphore:
                ...
                try:
                    ...
                    return TaskResult(
                        task_id=task_id, success=False, error=e, duration_ms=duration
                    )
    ...
    async def execute_streaming(
        self, tasks: list[T], worker: Callable[[T], Coroutine[Any, Any, Any]]
...
class RateLimiter:
    ...
    def __init__(self, calls_per_second: float = 10.0, burst_size: int = 1):
        """
...
async def gather_with_limit(
    coros: list[Coroutine[Any, Any, Any]], limit: int
) -> list[Any]:
    """
...
async def first_successful(
    coros: list[Coroutine[Any, Any, Any]], timeout: float | None = None
) -> Any:
    """
